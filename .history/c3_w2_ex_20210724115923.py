...
for line in file:  #line is list
    line = line.rstrip()
    nums_each_line = re.findall('[0-9]*',line) #list of strings
    l.append(nums_each_line) #l contains all strings of nums we want
#l_int = int(l) #convert to integers; int()can only convert strings but not list!!!
l_int = list()
for i in l:
